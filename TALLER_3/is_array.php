...
$miArray = ["Tomate", "Lechuga", "Mayonesa"]; // Reemplaza esto con tu propio array
$miString = "Super Monkey Ball"; // Reemplaza esto con tu propio string
$miNumero = 7650; // Reemplaza esto con tu propio número
