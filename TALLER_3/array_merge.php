...
$misComidas = ["Espagueti", "Helado de Menta", "Dulce de Helado"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Dulce Red Velvet", "Hamburguesa", "Nuggets de Pollo"]; // Reemplaza con las comidas favoritas de tu amigo
