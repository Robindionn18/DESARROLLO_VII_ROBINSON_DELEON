...
$misAmigos = ["Fernando", "Diego", "Oswaldo"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Elmer", "Edwin"); // Reemplaza las comillas vacías con los nombres de tus amigos
