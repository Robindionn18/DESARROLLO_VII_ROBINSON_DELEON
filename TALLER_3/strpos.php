...
$textoOriginal = "Este es un texto con algunas palabras que deben ser censuradas. Recuerda que esto debe ser confidencial.";
$palabrasCensuradas = ["texto", "palabras", "censuradas", "confidencial"];
